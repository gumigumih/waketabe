...
export const InputForm = ({ onShowResult }: InputFormProps) => {
  ...
  return (
    <div className="space-y-4">
      {/* 説明文を追加 */}
      <div className="text-center text-lg font-semibold text-gray-800 bg-white/80 rounded-lg p-2 shadow-sm">
        参加者を登録してください（ニックネームや本名どちらでもOK）
      </div>
      ...
      <Button
        ...
        className="w-full bg-lime-500 hover:bg-lime-700 font-bold text-lg"
      >
        計算結果を見る
      </Button>
    </div>
